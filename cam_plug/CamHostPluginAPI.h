#ifndef _CAM_HOST_PLUGIN_API_H_
#define _CAM_HOST_PLUGIN_API_H_
...
extern "C" {
     ...
     */
    DLL_EXPORT IHostRaysAPI* DLL_CALL MakeHostRaysEmitter(int a_pluginId);       ///<! you replace this function or make your own ... the example will be provided
    DLL_EXPORT void          DLL_CALL DeleteRaysEmitter(IHostRaysAPI* pObject);  ///<! don't forget to provide delete fuction because your DLL has different heap
}

static constexpr int HOST_RAYS_PIPELINE_LENGTH = 3;

#endif //_CAM_HOST_PLUGIN_API_H_
